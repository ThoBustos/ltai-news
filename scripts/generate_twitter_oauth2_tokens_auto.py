...
Automatically reads Client ID and Secret from .env file.
...
# Allow HTTP for localhost during token generation (safe for local development)
# OAuth 2.0 requires HTTPS by default, but we use http://127.0.0.1:8080/callback locally
...
def main():
    ...
    if not CLIENT_ID or not CLIENT_SECRET:
        print("❌ Error: TWITTER_OAUTH2_CLIENT_ID or TWITTER_OAUTH2_CLIENT_SECRET not found in .env")
        print()
        print("Please ensure these are set in your .env file:")
        print("  TWITTER_OAUTH2_CLIENT_ID=your_client_id")
        print("  TWITTER_OAUTH2_CLIENT_SECRET=your_client_secret")
        sys.exit(1)
    ...
    print()
    print("IMPORTANT: Copy the FULL redirect URL from your browser's address bar")
    print()
    ...
    print("="*70)
    print()
    print("UPDATE these lines in your .env file:")
    print()
    print(f"TWITTER_OAUTH2_ACCESS_TOKEN={token['access_token']}")
    print(f"TWITTER_OAUTH2_REFRESH_TOKEN={token.get('refresh_token', '')}")
    print()
    print("(Keep TWITTER_OAUTH2_CLIENT_ID and TWITTER_OAUTH2_CLIENT_SECRET as-is)")
    print()
    ...
    print("="*70)
    print()
    print("1. Copy the tokens above to your .env file")
    print("2. Ensure TWITTER_USE_OAUTH2=true is set")
    print("3. Restart your application")
    print("4. Test posting with: POST /api/x-thread/post-to-x/<date>")
    print()
